package com.liuy.manage;//package com.myLogger.http;
//
//import com.alibaba.fastjson.JSONObject;
//import com.myLogger.tools.json2map;
//import com.myLogger.consist.ErrorEnum;
//import com.myLogger.dao.entry.*;
//import com.myLogger.dao.mapper.*;
//import okhttp3.*;
...
//    json2map j2m;
//    @Autowired
//    GoodproxyMapper goodproxyMapper;
//    @Value("${table.number}")
//    String n;
...
//    }
//
//    public ResponseBody doFetchVersion2(String uid,IpProxy ipProxy){
//        OkHttpClient.Builder builder = new OkHttpClient().newBuilder();
//        ipProxy=getIpProxy(ipProxy);
...
//        try {
//
//            Goodproxy goodproxy=new Goodproxy();
//            //BeanUtils.copyProperties(ipProxy,goodproxy);
//            goodproxy.setIp(ipProxy.getIp());
//            goodproxy.setPort(ipProxy.getPort());
//            System.out.println(goodproxy);
//            goodproxyMapper.insertSelective(goodproxy);
//        }catch (Exception e){
//            return true;
//        }
//        return true;
//    }
//    public Boolean pushVersion2(String uid,String epoch){
//        Bilibilistep c=bilibilistepMapper.selectByPrimaryKey(epoch);
//        uid=selectUid(uid,epoch,c);
//        String ans=new String();
//        IpProxy ipProxy=new IpProxy();
